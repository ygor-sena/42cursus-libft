 ...
 *         aligned for any kind of variable. On error, these functions return
 ...
 *        substringfrom the string ’s’. The substring begins at index ’start’
 ...
 *        string representing the integer received as an argument. Negative
 ...
 *        of the string ’s’ to create a new string (with malloc(3)) resulting
 ...
 *        new element. The variable ’content’ is initialized with the value of
 ...
 *        the memory of the element’s content using the function ’del’ given as
